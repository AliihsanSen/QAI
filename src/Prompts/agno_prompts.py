...
def generate_gherkin_scenarios(manual_test_cases_markdown: str) -> str:
    ...
    try:
        # Türkçe çıktı için prompt'a açıklama ekle
        manual_test_cases_markdown_tr = manual_test_cases_markdown + "\n\nLütfen çıktıyı Türkçe olarak üret."
        run_response = gherkhin_agent.run(manual_test_cases_markdown_tr)
...
def generate_manual_test_cases(user_story: str) -> str:
    ...
    try:
        # Türkçe çıktı için prompt'a açıklama ekle
        user_story_tr = user_story + "\n\nLütfen çıktıyı Türkçe olarak üret."
        run_response = manual_test_case_agent.run(user_story_tr)
...
def enhance_user_story(user_story: str) -> str:
    ...
    try:
        # Türkçe çıktı için prompt'a açıklama ekle
        user_story_tr = user_story + "\n\nLütfen çıktıyı Türkçe olarak üret."
        run_response = user_story_enhancement_agent.run(user_story_tr)
